		...
		if (s_pos > -1 && tmp_test.indexOf("(", s_pos + 1)>-1) { // 存在多个运算
			...
			while (s_pos > -1) {
				...
				try {
					...
					System.out.println("Error at Process exp:" + tmp);
					e.printStackTrace();
				}
			...
			try {
				...
				System.out.println("Error at Process exp:" + tmp_test);
...
//		System.out.println(exp1 + operation + exp2);
		...
		if((value1 instanceof String) && ( "null".equalsIgnoreCase((String)value1) || "".equalsIgnoreCase((String)value1)))
			value1 = null;
		if((value2 instanceof String) && ( "null".equalsIgnoreCase((String)value2) || "".equalsIgnoreCase((String)value2)))
			value2 = null;
		...
		if (value1 instanceof String && value2 instanceof String) {
			...
			if (value1 instanceof Number && value2 instanceof Number) {
				...
				try {
					...
					System.out.println("Error at parseDouble exp:" + value2);
					e.printStackTrace();
				}
			} else {
				try {
					...
					System.out.println("Error at parseDouble exp:" + value1);
					e.printStackTrace();
				}
				tmp2 = ((Number) value2).doubleValue();
			}
