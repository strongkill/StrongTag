...
public final class Logs {
	...
	public static void init(){
		try {
			adapter = new SimplePluginManager<LogAdapter>(	"net.strong.log.impl.Log4jLogAdapter",
															"net.strong.log.impl.JdkLogAdapter",
															"net.strong.log.impl.SystemLogAdapter").get();
		}
		catch (Throwable e) {
			e.printStackTrace();
		}
