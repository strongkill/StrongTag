 ...
 * @author:
 * 
 * Last Modified:1,Strong Yuan,2005
 * 
...
public class MD5_deprecated {
	...
	private static MD5_deprecated instance = new MD5_deprecated();
	 ...
	 * @return
	 */
	public String getMD5ofStr16(String inbuf) {
		String result = getMD5ofStr(inbuf);
	...
	public String getMD5ofStr(String inbuf) {
		...
		if (inbuf == null || inbuf.trim().length() < 1)
			return null;
	...
	public static MD5_deprecated getInstance() {
		return instance;
	}
