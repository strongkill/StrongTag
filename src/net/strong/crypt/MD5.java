...
public class MD5 {
    ...
    public static String getMD5ofStr(String string) {
    	return getMD5ofStr(string,null);
    }
	public static String getMD5ofStr(String string,String charset_name) {
		MD5 md5 = new MD5();
	    try {
			md5.Update(string, charset_name);
			string = md5.asHex();
