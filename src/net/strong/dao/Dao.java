...
public interface Dao {
	 ...
	 * @return 插入后的对象
	 * 
	 * @see net.strong.dao.entity.annotation.Id
	 * @see net.strong.dao.entity.annotation.Default
	 * @see net.strong.dao.entity.annotation.Next
	 */
	<T> T insert(T obj);
	 ...
	 *            数据名值链
	 * 
	 * @see net.strong.dao.entity.annotation.Table
	 */
	 ...
	 * 如果想有选择的更新个别字段，请使用 net.strong.dao.FieldFilter
	 * <p>
	 ...
	 * 
	 * @see net.strong.dao.FieldFilter
	 */
	 ...
	 * 
	 * @return 影响的行数
	 * @see net.strong.dao.entity.annotation.Name
	 */
