...
import net.strong.dao.sql.DefaultStatementAdapter;
import net.strong.dao.sql.FetchEntityCallback;
import net.strong.dao.sql.FetchIntegerCallback;
import net.strong.dao.sql.FetchLongCallback;
import net.strong.dao.sql.FetchRecordCallback;
import net.strong.dao.sql.FetchStringCallback;
import net.strong.dao.sql.QueryEntityCallback;
import net.strong.dao.sql.QueryIntCallback;
import net.strong.dao.sql.QueryLongCallback;
import net.strong.dao.sql.QueryRecordCallback;
import net.strong.dao.sql.QueryStringCallback;
import net.strong.dao.sql.Sql;
import net.strong.dao.sql.SqlCallback;
import net.strong.dao.sql.SqlImpl;
import net.strong.dao.sql.SqlLiteral;
