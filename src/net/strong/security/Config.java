 ...
 * <br>
 * <b>Configuration file, reads the /com/temesoft/security/skewpassimage.properties
 * for configuration values</b>
 */
public class Config {
    ...
    static public final String CONFIG_FILE_CLASSPATH = "/net/strong/security/skewpassimage.properties";
        ...
        if (_properties == null) {
            try {
                ...
                InputStream stream = Config.class.
                        getClassLoader().getResourceAsStream(CONFIG_FILE_CLASSPATH);
