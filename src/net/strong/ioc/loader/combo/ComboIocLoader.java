...
public class ComboIocLoader implements IocLoader {
	 ...
	 * 这个构造方法需要一组特殊的参数
	 * <p/>
	 * 第一种,以*开头,后面接类名, 如 <code>*net.strong.ioc.loader.json.JsonLoader</code>
	 * <p/>
	 * 第二种,为具体的参数
	 * <p/>
	 ...
	 * 例子:
	 * <p/>
	 * <code>{"*net.strong.ioc.loader.json.JsonLoader","dao.js","service.js","*net.strong.ioc.loader.xml.XmlIocLoader","config.xml"}</code>
	 * <p/>
